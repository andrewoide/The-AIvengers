...
class FME_Elementor_Forms_Mask {
	...
	public function __construct() {
		add_action( 'elementor/element/ehp-form/section_form_fields/before_section_end', [ $this, 'add_mask_control' ], 100, 2 );
		add_filter( 'hello_plus/forms/render/item', [ $this, 'add_mask_atributes' ], 10, 3 );
	}
	/**
	 * Add mask control
	 *
	...
	public function add_mask_atributes( $field, $field_index, $form_widget ) {
		...
		do_action( 'helloplus_after_mask_attribute_added', $field, $field_index, $form_widget );
