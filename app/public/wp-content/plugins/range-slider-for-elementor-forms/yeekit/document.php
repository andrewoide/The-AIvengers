...
$yeekit_document_addons->set_document_link(
    array(
        "plugin" => "range-slider-for-elementor-forms/range-slider-for-elementor-forms.php",
        "pro" => "https://add-ons.org/plugin/elementor-forms-range-slider-fields/",
        "plugin_name" => "Range Slider for Elementor Forms",
