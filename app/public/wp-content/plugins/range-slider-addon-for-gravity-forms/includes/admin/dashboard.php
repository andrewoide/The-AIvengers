...
<div class="pcafe_header">
    <div class="pcafe_container">
        <div class="pcafe_header_content">
            <div class="logo">
                <img src="<?php echo esc_url(GF_NU_RANGE_SLIDER_URL . 'assets/images/range-slider.svg'); ?>">
                <span>Range Slider For Gravity Forms</span>
            </div>
            <div class="pcafe_btns">
                <a href="https://pluginscafe.com/demo/range-slider-for-gravity-forms/" target="_blank" class="pcafe_btn pcafe_demo">
                    <?php esc_html_e('Try Live Demo', 'range-slider-addon-for-gravity-forms'); ?>
                </a>
                <?php if (rsfgf_fs()->is_not_paying()) : ?>
                    <a href="<?php echo esc_url(rsfgf_fs()->get_upgrade_url()); ?>" target="_blank" class="pcafe_btn pcafe_pro">
            ...
            <ul class="pcafe_menu_wrap">
                <li class="active">
                    <a href="#introduction">
                        ...
                        <span><?php esc_html_e('Introduction', 'range-slider-addon-for-gravity-forms'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="#usage">
                        ...
                        <span><?php esc_html_e('Basic Usage', 'range-slider-addon-for-gravity-forms'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="#help">
                        ...
                        <span><?php esc_html_e('Help', 'range-slider-addon-for-gravity-forms'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="#pro">
                        ...
                        <span><?php esc_html_e('Get Pro', 'range-slider-addon-for-gravity-forms'); ?></span>
                    </a>
                </li>
                <li>
                    <a href="#otherplugins">
                        ...
                        <span><?php esc_html_e('Other Plugins', 'range-slider-addon-for-gravity-forms'); ?></span>
                    </a>
                </li>
            </ul>
        </div>
