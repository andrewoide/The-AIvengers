...
const decodedKey = urlParams.has('key') ? atob(urlParams.get('key')) : '';
const KeyParams = decodedKey ? new URLSearchParams(decodedKey) :'';
const cursor = Number(KeyParams.get('selection_tool'));
const scrolling = Number(KeyParams.get('scrolling'));
const spreads = Number(KeyParams.get('spreads'));
const zooming = KeyParams.get('pdf_zoom');
...
class BasePreferences {
  ...
  #defaults = Object.freeze({
    ...
    annotationMode: 2,
    cursorToolOnLoad: cursor,
    defaultZoomDelay: 400,
    defaultZoomValue: zooming,
    ...
    pdfBugEnabled: false,
    sidebarViewOnLoad: -1,
    scrollModeOnLoad: scrolling,
    spreadModeOnLoad: spreads,
    textLayerMode: 1,
    viewerCssTheme: 0,
    viewOnLoad: 0,
